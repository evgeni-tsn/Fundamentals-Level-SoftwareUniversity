...
class GenericArrSort
{
    ...
    //Make sure that what you're trying to sort can be sorted – your method should 
    //work with numbers, strings, dates, etc., but not necessarily with custom classes like Student.
